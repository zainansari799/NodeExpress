...
declare module 'node-ts' {
    ...
    export class TeamSpeakClient extends events.EventEmitter {
            ...
            /**
                ...
                */
            send(cmd: "login", params: LoginParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "logout"): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "version"): Q.Promise<CallbackData<VersionResponseData>>;
            send(cmd: "hostinfo"): Q.Promise<CallbackData<HostInfoResponseData>>;
            send(cmd: "instanceinfo"): Q.Promise<CallbackData<InstanceInfoResponseData>>;
            send(cmd: "instanceedit", params: InstanceEditParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "bindinglist"): Q.Promise<CallbackData<BindingListResponseData>>;
            send(cmd: "use", params: UseParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "serverlist", params: IAssoc<any>, options: string[]): Q.Promise<CallbackData<ServerListResponseData>>;
            send(cmd: "serverdelete", params: ServerDeleteParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "serverstart", params: ServerStartStopParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "serverstop", params: ServerStartStopParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "serverprocessstop"): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "serverinfo"): Q.Promise<CallbackData<ServerInfoResponseData>>;
            send(cmd: "serverrequestconnectioninfo"): Q.Promise<CallbackData<ServerRequstConnectionInfoResponseData>>;
            send(cmd: "serveredit", params: ServerEditParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "sendtextmessage", params: SendTextMessageParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "logadd", params: LogAddParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "gm", params: GmParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "channellist", params: IAssoc<any>, options: string[]): Q.Promise<CallbackData<ChannelListResponseData>>;
            send(cmd: "channelinfo", params: ChannelInfoParams): Q.Promise<CallbackData<ChannelInfoResponseData>>;
            send(cmd: "channeldelete", params: ChannelDeleteParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "clientlist", params: ClientListParams): Q.Promise<CallbackData<ClientListResponseData>>;
            send(cmd: "clientinfo", params: ClientInfoParams): Q.Promise<CallbackData<ClientInfoResponseData>>;
            send(cmd: "clientdbdelete", params: ClientDBDeleteParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "clientmove", params: ClientMoveParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "clientkick", params: ClientKickParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "clientpoke", params: ClientPokeParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "clientpermlist", params: ClientPermListParams, options: string[]): Q.Promise<CallbackData<ClientPermListResponseData>>;
            send(cmd: "clientaddperm", params: ClientAddPermParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "clientdelperm", param: ClientDeleteParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "messagedel", params: MessageDeleteParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "complaindelall", params: ComplainDeleteAllParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "complaindel", params: ComplainDeleteParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "banclient", params: BanClientParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "banlist"): Q.Promise<CallbackData<BanListResponseData>>;
            send(cmd: "banadd", params: BanAddParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "bandel", params: BanDeleteParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "bandelall"): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: "ftstop", params: FtStopParams): Q.Promise<CallbackData<GenericResponseData>>;
            send(cmd: string, params: IAssoc<Object>, options: string[]): Q.Promise<CallbackData<QueryResponseItem>>;
            /**
